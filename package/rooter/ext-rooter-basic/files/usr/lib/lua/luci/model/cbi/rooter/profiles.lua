...
di = m:section(TypedSection, "default", translate("编译 & 汉化 @匕首，昔年"), translate("一般只需要填写您运营商的APN即可，一般已经自动加载识别了，奇葩虚拟运营商你也可以继续填 Tips:模块下次重连后生效，如果你要现在生效，请保存后重启模块）## 华为天际通5G SA APN：5gscuiot ##"))
di.anonymous = true
...
if (multilock == "0") or (multilock == "1" and rootlock == "1") then
	...
	bwday = di:taboption(this_tab, ListValue, "bwday", translate("发送监测信息的日期 :"),
		translate("每月发送监测报告文件的日期，请选择在每个月的第几日发送，不需要请选择禁用   汉化 & 编译 @匕首，昔年"))
	bwday.default = "0"
